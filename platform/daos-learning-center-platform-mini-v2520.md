...
- [Configuración inicial](#configuración-inicial)
  ...
  - [Configuración del SDK](#configuración-del-sdk)
  - [Archivo pom.xml](#archivo-pomxml)
  - [Proyecto LearningCenterPlatformApplication](#proyecto-learningcenterplatformapplication)
  - [Archivo application.properties](#archivo-applicationproperties)
- [Shared package](#shared-package)
  - [Project structure for shared](#project-structure-for-shared)
  - [Package domain.model.aggregates](#package-domainmodel-aggregates)
  - [Package domain.model.entities](#package-domainmodel-entities)
  - [Package infrastructure.documentation.openapi.configuration](#package-infrastructuredocumentationopenapi-configuration)
  - [Package infrastructure.persistence.jpa.configuration.strategy](#package-infrastructurepersistencejpa-configuration-strategy)
  - [Package interfaces.rest.resources](#package-interfacesrest-resources)
- [Profile Bounded Context](#profile-bounded-context)
  - [Project structure for profiles](#project-structure-for-profiles)
  - [Package domain.model.valueobjects](#package-domainmodel-valueobjects)
  - [Package domain.model.aggregates (Profile)](#package-domainmodel-aggregates-profile)
  - [Package domain.model.queries](#package-domainmodel-queries)
  - [Package domain.model.commands](#package-domainmodel-commands)
  - [Package domain.services](#package-domainservices)
  - [Package infrastructure.persistence.jpa.repositories](#package-infrastructurepersistencejpa-repositories)
  - [Package application.internal.queryservices](#package-applicationinternal-queryservices)
  - [Package application.internal.commandservices](#package-applicationinternal-commandservices)
  - [Package interfaces.rest.resources](#package-interfacesrest-resources)
  - [Package interfaces.rest.transform](#package-interfacesrest-transform)
  - [Package interfaces.rest (ProfilesController)](#package-interfacesrest-profilescontroller)
  - [Package interfaces.acl (ProfilesContextFacade)](#package-interfacesacl-profilescontextfacade)
- [Generación de las Tablas en la Base de datos](#generación-de-las-tablas-en-la-base-de-datos)
- [Learning Bounded Context](#learning-bounded-context)
  - [Project structure for learning](#project-structure-for-learning)
  - [Package domain.model.valueobjects (ProfileId, StudentCode)](#package-domainmodel-valueobjects-profileid-studentcode)
  - [Package domain.model.aggregates (Student)](#package-domainmodel-aggregates-student)
  - [Package domain.model.queries](#package-domainmodel-queries-learning)
  - [Package domain.model.commands](#package-domainmodel-commands-learning)
  - [Package domain.services (StudentCommandService, StudentQueryService)](#package-domainservices-student)
  - [Package infrastructure.persistence.jpa.repositories (StudentRepository)](#package-infrastructurepersistencejpa-repositories-student)
  - [Package application.internal.queryservices (StudentQueryServiceImpl)](#package-applicationinternal-queryservices-studentqueryserviceimpl)
  - [Package application.internal.outboundservices.acl (ExternalProfileService)](#package-applicationinternal-outboundservices-acl-externalprofileservice)
  - [Package application.internal.commandservices (StudentCommandServiceImpl)](#package-applicationinternal-commandservices-studentcommandserviceimpl)
  - [Package interfaces.rest.resources (CreateStudentResource, StudentResource, ProfileResource)](#package-interfacesrest-resources-student)
  - [Package interfaces.rest.transform](#package-interfacesrest-transform-student)
  - [Package interfaces.rest (StudentsController)](#package-interfacesrest-studentscontroller)
- [Testing RESTful Api (Swagger UI)](#testing-restful-api-swagger-ui)

## Configuración inicial

### Base de datos

**Abrir** el `pgAdmin`, ingrese la contraseña `12345678` y **crear** la base de datos: `learningmini`.
...
![learning-shared-pk](images/Learning-shared-pk.png)

### Project structure for shared
...
![learning-sp-pk](images/Learning-sp-pk.png)
...
En el package `aggregates` en la clase `Profile` quite el comentario de las siguientes líneas de código:
